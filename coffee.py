...
with col1:
    ...
    st.plotly_chart(fig)
    st.write("Berdasarkan grafik diatas, negara Brazil menempati peringkat pertama sebagai negara dengan ekspor\
        terbanyak di dunia yaitu sebanyak 33.8jt ton kopi selama periode 1990-2020, disusul oleh negara seperti Viet Nam, Colombia, dan Indonesia.")
...
with col2:
    ...
    st.write("Dari grafik diatas, menunjukan bahwa negara USA menjadi negara importir kopi paling banyak dunia\
        yaitu sebanyak 42.5jt ton selama periode 1990-2020, disusul oleh negara seperti Jerman, Italy dan Jepang")
...
st.write('Dari data konsumsi kopi domestik diatas menunjukan bahwa negara Brazil memiliki angka konsumsi kopi tertinggi dibanding dengan\
    negara negara produsen kopi lainnya yaitu sebanyak 27,8jt ton selama periode 1990-2020, disusul oleh negara seperti Indonesia, Ethopia, dan Mexico.')
...
st.write('Disisi lain, Negara USA menempati peringkat pertama sebagai negara Importir kopi dengan tingkat konsumsi tertinggi di dunia\
    yaitu sebanyak 37.8jt ton selama periode 1990-2020, disusul oleh Jerman dan Jepang')
